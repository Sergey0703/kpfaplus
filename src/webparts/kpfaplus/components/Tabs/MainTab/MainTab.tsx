      ...
      <div style={buttonContainerStyle}>
        {isEditMode ? (
          ...
          <>
            ...
            <IconButton 
              iconProps={{ 
                iconName: selectedStaff.deleted ? 'RedoSolid' : 'Delete' 
              }} 
              title={selectedStaff.deleted ? "Восстановить" : "Удалить"} 
              ariaLabel={selectedStaff.deleted ? "Восстановить" : "Удалить"}
              onClick={onDelete}
              styles={{
                icon: selectedStaff.deleted ? restoreButtonStyle : deleteButtonStyle
              }}
            />
          </>
        )}
